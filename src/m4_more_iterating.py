...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 2
    actual = count_positive_sines([34, 22, 1, 68])
    print()
    ...
    # Test 12:
    expected = 0
    actual = count_positive_sines([500])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 404
    actual = sum_first_n([484, -80, 34, 67], 2)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected =24
    actual = sum_first_n([21, 18, -50, 35, 65, 98, 4334, 6434], 4)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
